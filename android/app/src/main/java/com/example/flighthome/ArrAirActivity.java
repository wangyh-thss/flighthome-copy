...
public class ArrAirActivity extends AppCompatActivity {
    ...
    private void getairportIata(){
        ...
        Call<JsonArray> call = retrofitAPI.getAirportIata(MainActivity.toCity);
            ...
            public void onResponse(Call<JsonArray> call, Response<JsonArray> response) {
                ...
                try {
                    if (response.body() != null) {
                        ...
                        Intent settingsIntent = new Intent(ArrAirActivity.this, HomeActivity.class);
